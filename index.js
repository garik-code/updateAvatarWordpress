    ...
    const User = require('./lib/user'); // Подключаем самописный модуль для обновления аватарки Wordpress (https://github.com/garik-code/updateAvatarWordpress/blob/master/lib/user.js)
